...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Blind Test Api web application."
  #
  #
  ...
  #
  # settings.secret_key_base= A_UOiLOCBww-sJgfGLyqsZ0F8wsaFF3XfWfUr_6n-w4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("blind-test-api.log", "w"))
  #
  #
end
